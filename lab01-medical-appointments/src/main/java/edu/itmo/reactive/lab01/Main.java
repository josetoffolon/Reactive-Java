...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<MedicalAppointment> appointments = generator.generateAppointments(10);

        AppointmentStatisticsCalculator calculator = new AppointmentStatisticsCalculator();
        AppointmentStatistics statistics = calculator.calculatedWithLoop(appointments);
        ...
        for(MedicalAppointment appointment: appointments){
            ...
            System.out.println("Time: "+ appointment.getAppointmenTime());
